...
class Test(unittest.TestCase):
    ...
    # def test_MazeLoader_master_list(self):
    #     m = MazeLoader()
    #     print(m.master_list.keys())
    #     print(len(m.master_list.keys()))
    #     actual = len(m.master_list.keys())
    #     expected = 100
    #     self.assertEqual(actual, expected)

    def test_ReferenceMazeRunner_simplemaze(self):
        actual = ReferenceMazeRunner()
        expected = ['North', 'East']
        self.assertEqual(actual, expected)

    def test_ReferenceMazeRunner_generated100maze(self):
        runner = ReferenceMazeRunner()
        # actual = runner.run(self.master_list.get(start), self.master_list.get(end))
        actual = runner.run()
...
# python3 -m unittest /home/mauratee/src/mazes-takehome/src/samples/generated100.maze
